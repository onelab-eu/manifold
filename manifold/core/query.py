...
class Query(object):
    ...
    def to_json(self, analyzed_query = None):
        ...
        f = json.dumps(self.get_where().to_list())
        p = json.dumps(self.get_params())
        c = json.dumps(list(self.get_select()))
    ...
    def fill_from_POST (self, POST_dict):
        try:
            ...
            Log.warning("Could not decode incoming ajax request as a Query, POST=", POST_dict)
